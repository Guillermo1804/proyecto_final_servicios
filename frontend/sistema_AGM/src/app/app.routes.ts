...
export const routes: Routes = [
...

	{
		...
		// data: { roles: ['admin'] },
		loadChildren: () =>
			import('./screens/admin-screen/admin.routes')
...

	{
		...
		// data: { roles: ['docente'] },
		loadChildren: () =>
			import('./screens/docente-screen/docente.routes')
				.then((routes) => routes.DOCENTE_ROUTES)
	},

	{
		...
		// data: { roles: ['alumno'] },
		loadChildren: () =>
			import('./screens/alumno-screen/alumno.routes')
				.then((routes) => routes.ALUMNO_ROUTES)
	},
