...
def _persist_outbox_row(envelope, stored_payload: dict, correlation_id: str, event_name: str) -> None:
    ...
    *,
    ...
    if on_commit:
        transaction.on_commit(
            lambda: _persist_outbox_row(envelope, stored_payload, correlation_id, event_name)
        )
    else:
        _persist_outbox_row(envelope, stored_payload, correlation_id, event_name)
